      ...
      <div className="w-[70%] text-[#999999]">
        ...
        <div className="grid grid-cols-12 gap-5">
          {currentImages.map((ele, index) => (
            <div
              className="col-span-12 text-center md:col-span-6 mb-3 cursor-pointer"
              key={index}
            >
              <div className={`${Styles.member}`}>
                <img
                ...
                />
                <div
                  className={`${Styles.img_caption} flex flex-col justify-around items-center`}
                >
                  <div>
                  ...
                  <div className={`flex items-center gap-3 ${Styles.icon}`}>
                    ...
                    <div className="bg-gray-200 p-2 rounded flex gap-1 items-center">
                      <FaRegEye className="text-[#000] text-[20px]" />
                      <span className="underline text-[#000] text-[12px]">
                        100
                      </span>
                    </div>
                    <div className="bg-gray-200 p-2 rounded flex gap-1 items-center">
